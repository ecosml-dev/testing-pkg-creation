...
from numpy import *
from os import path
from ecosml_model_utils import load_constants
...
def run(spectra):
    ...
    coefs_single=load_constants('PLSR_coefficients_Raw_Aggregated_Nitrogen.csv')
    # ...array, gets mean and uncertainty per pixel)
    coefs_multpl=load_constants('PLSR_coefficients_Raw_Full_Nitrogen.csv')
